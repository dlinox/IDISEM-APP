<template>
    <form @submit.prevent="submit">
        <div class="mt-2 mb-4 mx-4 text-center">
            <label for="code" class="form-label"
                >Ingrese su codigo de matricula</label
            >
            <input
                v-model="form.code"
                type="text"
        ...
        <div class="mb-3 d-grid gap-2 d-md-flex justify-content-center">
            <button
                class="btn btn-dark"
                type="button"
                @click="dialogRegister = !dialogRegister"
            >
    ...
    <ModalComponent v-model="dialogRegister">
        <template #content>
            <div class="fw-bold">Registrarme</div>
            <hr />

            <div class="alert alert-warning">
                Solo si su codigo de matricula no se encuentra registrado
            </div>

            <FormRegisterEstudianteComponent
                @onCancel="dialogRegister = false"
                @onSubmit="dialogRegister = false"
            />
        </template>
    </ModalComponent>
...
import FormRegisterEstudianteComponent from "./FormRegisterEstudianteComponent.vue";
